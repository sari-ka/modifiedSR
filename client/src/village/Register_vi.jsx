...
function Register_vi() {
  ...
  return (
    ...
    <form action="" className='w-50 d-block mx-auto border border-light-subtle p-3 px-4 rounded-4 bg-white' onSubmit={handleSubmit(handleVillagerRegistration)}>
    <h2 className='text-center mb-4'></h2>
      ...
      <Link to="/village" className="text-decoration-none">Already have an account? Log in</Link>
    </div>
    </form>
  </div>
  )
